		...
		<div class="modal-body">
			...
			<div class="form-group has-feedback">
				<select id="className" name="className" class="form-control">
					<option value="기사" <?php if ($memberDetail['className'] == 1) echo "기사";?>>기사</option>
					<option value="요정" <?php if ($memberDetail['className'] == 1) echo "요정";?>>요정</option>
					<option value="마법사" <?php if ($memberDetail['className'] == 1) echo "마법사";?>>마법사</option>
					<option value="다크엘프" <?php if ($memberDetail['className'] == 1) echo "다크엘프";?>>다크엘프</option>
					<option value="총사" <?php if ($memberDetail['className'] == 1) echo "총사";?>>총사</option>
					<option value="투사" <?php if ($memberDetail['className'] == 1) echo "투사";?>>투사</option>
				</select>
			</div>
